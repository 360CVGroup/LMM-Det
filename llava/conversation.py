...
# same as conv_vicuna_v1, just for random select category
...
default_conversation = conv_vicuna_v2
conv_templates = {
    ...
    "v2": conv_vicuna_v2,
    "vicuna_v2": conv_vicuna_v2,
}


if __name__ == "__main__":
    print(default_conversation.get_prompt())
    # print(default_conversation.tokenizer)
